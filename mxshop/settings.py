...
SECRET_KEY = '8q_0&o=t^6c%ud*k(qb$bo5^cq0xvd=k(3crmp*f4hgwj-l8@c'
...
# ali_return_url = "http://10.10.10.167:8000/alipay/return"
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://10.10.10.2:6379",
        ""
        "OPTIONS": {
...
SOCIAL_AUTH_WEIBO_KEY = '836476381'
SOCIAL_AUTH_WEIBO_SECRET = '18b92462b31c113887978e88134cf190'
